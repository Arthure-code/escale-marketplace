...
namespace Escale.Web.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostRemoveLoginAsync(string loginProvider, string providerKey)
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Erreur : la connexion externe n'a pas été retirée.";
                return RedirectToPage();
            }

            await _signInManager.RefreshSignInAsync(user);
            StatusMessage = "La connexion externe a été retirée.";
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Erreur : la connexion externe n'a pas été ajoutée. Une connexion externe ne peut être associée qu'à un seul compte.";
                return RedirectToPage();
            }
