        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abonnement_Debut = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Abonnement_Mensualite = table.Column<int>(type: "INTEGER", nullable: false),
                    Abonnement_Echeance = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Blocage_Debut = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Blocage_Fin = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Blocage_Motif = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    LoueurId = table.Column<string>(type: "TEXT", nullable: false),
                    Categorie = table.Column<int>(type: "INTEGER", nullable: false),
                    Titre = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 600, nullable: false),
                    PrixJournalier = table.Column<int>(type: "INTEGER", nullable: false),
                    Photo = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    ...
                    Couchages = table.Column<int>(type: "INTEGER", nullable: true),
                    Marque = table.Column<string>(type: "TEXT", maxLength: 60, nullable: true),
                    Annee = table.Column<int>(type: "INTEGER", nullable: true),
                    Places = table.Column<int>(type: "INTEGER", nullable: true),
                    Exemplaires = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Annonces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Annonces_AspNetUsers_LoueurId",
                        column: x => x.LoueurId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuatreDerniers = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnonceEquipements", x => new { x.AnnonceId, x.EquipementId });
                    table.ForeignKey(
                        name: "FK_AnnonceEquipements_Annonces_AnnonceId",
                        column: x => x.AnnonceId,
                        principalTable: "Annonces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnonceEquipements_Equipements_EquipementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LignesPanier_Annonces_AnnonceId",
                        column: x => x.AnnonceId,
                        principalTable: "Annonces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateDebut = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateFin = table.Column<DateTime>(type: "TEXT", nullable: false),
                    NombreDeJours = table.Column<int>(type: "INTEGER", nullable: false),
                    SousTotal = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LignesCommande", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LignesCommande_Annonces_AnnonceId",
                        column: x => x.AnnonceId,
                        principalTable: "Annonces",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnonceEquipements_EquipementId",
                table: "AnnonceEquipements",
                column: "EquipementId");

            migrationBuilder.CreateIndex(
                name: "IX_Annonces_LoueurId",
                table: "Annonces",
                column: "LoueurId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LignesCommande_AnnonceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LignesPanier_AnnonceId",
                table: "LignesPanier",
                column: "AnnonceId");
        }
